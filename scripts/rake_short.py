...
cube('Bed',(0,1.15,.55),(1.45,2.15,.38),bedmat,.08); cube('Headboard',(0,3.05,1.25),(1.55,.12,.8),wood,.05); cube('Pillow',(0,2.35,1.03),(1.05,.5,.18),bedmat,.12)
# window ominous rectangle
cube('Window',(1.9,3.94,2.05),(.72,.04,.85),moon,.01)
# human lying then fighting: parent empty
...
# sunken eye sockets + emissive pin eyes
for s in (-1,1):
...
# 30 sec at 24 fps: stalk, call-response, charge, fight, fake calm, final rush
...
sc.render.engine='BLENDER_EEVEE_NEXT';sc.render.image_settings.color_mode='RGB';sc.world.color=(.002,.003,.008)
# compositor slight glare
...
# human call, creature answer, charge/fight, final scream
